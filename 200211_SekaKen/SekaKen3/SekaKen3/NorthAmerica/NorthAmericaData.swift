...
func NorthAmericaList()->[NorthAmericaData]{
    ...
    NorthAmericaArray.append(NorthAmericaData(id:11, imageName:"61", title: "アメリカ", ファイル名: AnyView(LandmarkList())))
    NorthAmericaArray.append(NorthAmericaData(id:13, imageName:"62", title: "カナダ", ファイル名: AnyView(LandmarkList())))
